...
QUESTIONS = {
    "1-1": {"step": 1, "title": "Step 1. 소리와 수학 연결하기", "text": "목표 소리의 세 가지 특징은 각각 수학식의 어떤 변수(A, B, C, D)와 가장 관련이 깊을까요? 구체적으로 서술해주세요.", "dimension": "다른 표상", "max_score": 1},
    ...
    "1-3": {"step": 1, "title": "Step 1. 소리와 수학 연결하기", "text": "여러분이 만든 식에서 각각의 변수(A, B, C, D) 값은 현실 세계의 '소리'에서 구체적으로 무엇을 의미할까요?", "dimension": "다른 표상", "max_score": 1},
    "2-1": {"step": 2, "title": "Step 2. 나만의 사운드 만들기", "text": "'사운드 디자인 목표'를 달성하기 위해 각각의 변수(A, B, C, D)의 값을 어떻게 정했나요? 어떤 생각이나 계산 과정을 거쳤는지 알려주세요.", "dimension": "절차", "max_score": 2},
